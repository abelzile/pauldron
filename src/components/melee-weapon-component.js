...
export default class MeleeWeaponComponent extends WeaponComponent {
  ...
  clone() {
    return new MeleeWeaponComponent(this.weaponTypeId, this.weaponMaterialTypeId, this.handedness, this.attackShape, this.gradientColor1, this.gradientColor2, this.glowColor);
  }
